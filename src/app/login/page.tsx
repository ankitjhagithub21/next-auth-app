  ...
  return (
    <div className='h-screen w-full flex items-center justify-center'>
      <div className='lg:w-1/4 md:w-1/2 w-full  p-5 rounded-xl'>
        ...
        <h2 className='mb-5 text-xl text-center'>Login now.</h2>
        ...
        <p className='mt-5 text-center'>Don't have an account ? <Link className='underline text-primary' href={"/signup"}>Register</Link>  </p>
      </div>
    </div>
  )
}
